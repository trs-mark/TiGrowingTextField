...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','net.iamyellow.tigrowingtextfield.js')
	...
	f = os.path.join(cwd,'Classes','NetIamyellowTigrowingtextfieldModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','net.iamyellow.tigrowingtextfield.js']
...
def glob_libfiles():
	...
	for libfile in glob.glob('build/**/libNetIamyellowTigrowingtextfield.a'):
